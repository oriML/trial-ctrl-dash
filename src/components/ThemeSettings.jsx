  ...
  return (
    ...
    <div className="bg-half-transparent w-screen fixed nav-item top-0 right-0" >
      ...
      <div className="flex-col border-t-1 border-color p-4 ml-4">
        <p className="font-semibol tex-lg">Theme Options</p>
        <div className="mt-4">
          <input
            type="radio"
            id="light"
      ...
      <div className="flex-col border-t-1 border-color p-4 ml-4">
        <p className="font-semibol tex-lg">Theme Colors</p>
        <div className="flex gap-3">
          {
            themeColors.map((item, index) => (
              ...
              position="TopCenter"
              >
                <div className="relative mt-2 cursor-pointer flex gap-3 items-center">
                  <button
                  type="button"
