  ...
  <div className="flex m-3 flex-wrap justify-center gap-1 items-center">
    {earningData.map(item => (
      ...
      <div className="flex gap-10 flex-wrap justify-center" >
          <div className="bg-white dark:text-gray-200 darg:bg-secondary-dark-bg m-3 rounded-2xl md:w-780">
            <div className="flex
            justify-between">
        ...
        <div className="mt-10 flex gap-10 flex-wrapjustify-center" >
